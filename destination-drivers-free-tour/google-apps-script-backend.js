 ...
 * Free serverless backend that validates daily limits and submits to Airtable
 *
 * SETUP:
 ...
 *    - AIRTABLE_TABLE_ID = your table ID (tbl...)
 * 5. Deploy as Web App (Deploy → New deployment)
 *    - Execute as: Me
 *    - Who has access: Anyone
 * 6. Copy the web app URL and use in your website
 */
